...
export default function PassportView({ stamps, score, threshold, ethAddress, txHash, mintedAt }: Props) {
  ...
  return (
    <div className="rounded-xl border border-zinc-700 bg-zinc-900 overflow-hidden" style={{ fontFamily: 'monospace' }}>
      ...
      <div className="px-5 pt-4 pb-3 border-b border-zinc-800 flex items-start justify-between"
